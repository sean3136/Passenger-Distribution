class bus:
    ...
    def __init__(self, bus_id, bus_capacity, bus_current_capacity):
        self.bus_id = bus_id
    ...
    def set_bus_current_capacity(self, bus_current_capacity):
        self.bus_current_capacity = bus_current_capacity
    ...
    def get_bus_current_capacity(self):
        return str(self.bus_current_capacity)
